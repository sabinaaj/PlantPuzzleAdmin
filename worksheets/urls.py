...
from .views import WorksheetListView, WorksheetCreateView, LoadTaskFormView, WorksheetDeleteView, \
    WorksheetUpdateView, CheckFormDataAjaxView, WorksheetByAreaAPIView
...
urlpatterns = [
    ...
    path('api/<int:area_id>/worksheets/', WorksheetByAreaAPIView.as_view(), name='worksheets_by_area'),
]
